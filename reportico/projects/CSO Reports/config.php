...
define('SW_PROJECT_TITLE', 'CSO Reports');
...
define('SW_DB_USER', $clearDB_url["user"]);
define('SW_DB_PASSWORD', $clearDB_url["pass"]);
define('SW_DB_HOST', $clearDB_url["host"]);
define('SW_DB_DATABASE', substr($clearDB_url["path"], 1));
}
