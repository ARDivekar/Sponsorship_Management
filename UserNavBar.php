            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="companies.php"><i class="fa fa-table fa-fw"></i> Companies</a>
                        </li>
						<li>
                            <a href="#"><i class="glyphicon glyphicon-calendar"></i> Meeting Log</a>
                        </li>
						<li>
                            <a href="#"><i class="glyphicon glyphicon-usd"></i> Account Log</a>
                        </li>
                        <li>
                            <a href="CSO_reports.php"><i class="fa fa-edit fa-fw"></i> Reports</a>
                        </li>
                        <li>
