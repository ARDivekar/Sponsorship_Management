...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 22, 2015 at 12:59 PM
...
CREATE TABLE IF NOT EXISTS `committeemember` (
  `StudID` int(9) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `festival` (
  `FestName` varchar(20) NOT NULL,
  `StartDate` date DEFAULT NULL,
  `EndDate` date DEFAULT NULL,
  PRIMARY KEY (`FestName`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `meeting` (
  ...
  `SponsID` int(9) unsigned NOT NULL DEFAULT '0',
